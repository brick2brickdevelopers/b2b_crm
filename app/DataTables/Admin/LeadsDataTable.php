...
class LeadsDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ...
            ->addColumn('checkbox', function ($row) {
                ...
                return "<input type='checkbox' id='" . $row->id . "' name='sms' value='" . $row->id . "'>";
            })
    ...
    public function query(User $model)
    {
        ...
        $lead = Lead::select(
            ...
            'users.image',
            \DB::raw("(select next_follow_up_date from lead_follow_up where lead_id = leads.id and leads.next_follow_up  = 'yes' and next_follow_up_date >= '{$currentDate}' ORDER BY next_follow_up_date asc limit 1) as next_follow_up_date"),
    ...
    protected function getColumns()
    {
        return [
            ...
            'checkbox' => ['data' => 'checkbox', 'orderable' => false, 'searchable' => false, 'title' => '<input type="checkbox" id="selectAll" value="true">'],
