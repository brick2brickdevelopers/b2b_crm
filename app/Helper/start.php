...
if (!function_exists('fixSipDuplicate')) {

    function fixSipDuplicate()
    {
...
if (!function_exists('call_outcome')) {
    ...
    function call_outcome()
    {
        $array = array(
            ...
            ['id' => 2, 'label' => 'Running'],
            ['id' => 3, 'label' => 'Both Answered'],
            ['id' => 4, 'label' => 'To (Customer) Answered - From (Agent) Unanswered'],
            ['id' => 5, 'label' => 'To (Customer) Answered'],
            ['id' => 6, 'label' => 'To (Customer) Unanswered - From (Agent) Answered'],
            ['id' => 7, 'label' => 'From (Agent) Unanswered'],
            ['id' => 8, 'label' => 'To (Customer) Unanswered'],
            ['id' => 9, 'label' => 'Both Unanswered'],
            ['id' => 10, 'label' => 'From (Agent) Answered'],
            ['id' => 11, 'label' => 'Rejected Call'],
            ['id' => 12, 'label' => 'Skipped'],
            ['id' => 13, 'label' => 'From (Agent) Failed'],
            ['id' => 14, 'label' => 'To (Customer) Failed - From (Agent) Answered'],
            ['id' => 15, 'label' => 'To (Customer) Failed'],
            ['id' => 16, 'label' => 'To (Customer) Answered - From (Agent) Failed'],
        );
