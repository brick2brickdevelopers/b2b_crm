...
class User extends BaseModel implements AuthenticatableContract, CanResetPasswordContract
{
    ...
    protected $fillable = [
        'name', 'email', 'password', 'mobile', 'login', 'status', 'image', 'gender', 'locale', 'onesignal_player_id', 'email_notifications', 'country_id', 'sip_user', 'sip_pass'
    ];
    ...
    public $appends = ['image_url', 'modules', 'user_other_role', 'cmodules'];
    ...
    public function getModulesAttribute()
    {
        ...
        if ($user) {
            ...
            // $module->select('module_name', 'custom_name');
    ...
    public function getCmodulesAttribute()
    {
        $user = auth()->user();
