...
<ul class="nav tabs-vertical">
    ...
    <li class="tab @if(\Illuminate\Support\Facades\Route::currentRouteName() == 'admin.payroll-setting.index') active @endif">
                <a href="{{ route('admin.payroll-setting.index') }}">@lang('app.menu.payroll') @lang('app.menu.settings')</a></li>
