                                                            ...
                                                            <div class="row">
                                                                    ...
                                                                    @if (in_array($module, $worksuitePlugins))
                                                                        @if (config(strtolower($module) . '.setting'))
                                                                            ...
                                                                            @if (config(strtolower($module) . '.verification_required') && $fetchSetting->purchase_code)
                                                                                <span
                                                                                    class="blur-code purchase-code">{{ $fetchSetting->purchase_code }}</span>
                                                                                <span class="show-hide-purchase-code"
                                                                                    data-toggle="tooltip"
                                                                                    data-original-title="{{ __('messages.showHidePurchaseCode') }}">
                                                                                    <i
                                                                                        class="icon fa fa-eye-slash fa-fw cursor-pointer"></i>
                                                                                </span>
                                                                            @else
                                                                                <a href="javascript:;"
                                                                ...
                                                                <div class="col-md-2 text-right">
                                                                    <div class="switchery-demo">
                                                                        <input type="checkbox"
                                                                            @if (in_array($module, $worksuitePlugins)) checked @endif
