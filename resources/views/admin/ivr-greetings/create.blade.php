                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                {!! Form::open(['id' => 'createIvrGreeting', 'class' => 'ajax-form', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                                <div class="row">
...
@push('footer-script')
    ...
    <script>
        $('#createIvrGreeting').submit(function(e) {
            e.preventDefault();
            $.easyAjax({
                url: '{{ route('admin.ivr-greetings.store') }}',
                container: '#createIvrGreeting',
                type: "POST",
                file: true,
                redirect: true,
                dataType: 'JSON',
