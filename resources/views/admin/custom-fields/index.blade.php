                    ...
                    <div class="tab-content">
                        <div id="vhome3" class="tab-pane active">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <button id="add-field" class="btn btn-success btn-outline"><i
                                                class="fa fa-plus"></i> @lang('modules.customFields.addField')
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="table-responsive">
                                <hr>
                                <table
                                    class="table  table-bordered table-hover table-checkable order-column dataTable no-footer"
                                    id="custom_fields">
                                    <thead>
                                        <tr>
                                            <th>#</th>
