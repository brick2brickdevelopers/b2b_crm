...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-6 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            <a href="{{ route('admin.call-outcome.create') }}"
            class="btn btn-outline btn-success btn-sm">Add Call Outcome <i class="fa fa-plus"
                                            ...
                                            <td class=" text-center">
                                                <div class="btn-group dropdown m-r-10">
                                                    ...
                                                    <ul role="menu" class="dropdown-menu pull-right">
                                                        <li><a href="{{ route('admin.call-outcome.edit', $callOutcome->id) }}"
                                                                type="button"><i class="fa fa-pencil"
                                                                    aria-hidden="true"></i>
                                                                Edit</a></li>
                                                     
                                                        <li><a
                                                                href="{{ route('admin.call-outcome.destroy', $callOutcome->id) }}"><i
