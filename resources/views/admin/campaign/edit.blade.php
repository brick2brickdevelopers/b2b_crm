                    ...
                    <div class="panel-body">
                        <form method="POST" action="" class="form-horizontal" id="createCampaign">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" id="type" name="type" value="{{ $campaign->type }}"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-lg-10">
                                    <select name="status" class="form-control">
                                        <option value="1" {{ $campaign->status == 1 ? 'selected' : '' }}>Pause
                                        </option>
                                        <option value="2" {{ $campaign->status == 2 ? 'selected' : '' }}>Stop
                                        </option>
                                        <option value="3" {{ $campaign->status == 3 ? 'selected' : '' }}>Resume
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <input type="text" autocomplete="off" name="start_date" id="start_date"
                                        value="{{ $campaign->start_date }}" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row mb-2">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-lg-10">
                                    <input type="number" class="form-control" id="call_to_call_gap" name="call_to_call_gap"
                                        value="{{ $campaign->call_to_call_gap }}">
                                </div>
                            </div>
                            <div class="form-group row mb-2">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-lg-10">
                                    <input type="number" class="form-control" id="caller_id" name="caller_id"
                                        value="{{ $campaign->call_to_call_gap }}">
                                </div>
                            </div>
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-lg-10" id="agentselect">
                                    <select class="select2" multiple="multiple" id="agent" name="agent[]"
                                        data-placeholder="Choose Agent ...">
                                        @foreach ($employee as $item)
                                            <option value="{{ $item->user_id }}"
                                                {{ $campaign->agents->where('employee_id', $item->user_id)->count() == 1 ? 'selected' : '' }}>
                                                {{ $item->user->name }}
