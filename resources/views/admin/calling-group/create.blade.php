    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-inverse">
                <div class="panel-heading">@lang('app.add') Calling Group</div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="calling_group_name" name="calling_group_name">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div  id="employees">
                                    <select class="select2 select2-multiple" multiple="multiple" id="employees" name="employees[]"
                                ...
                                <a href="{{route('admin.calling-group.index')}}" class="btn btn-default waves-effect waves-light">@lang('app.back')</a>
                                {!! Form::close() !!}
                            </div>
                        </div>
                    </div>
