...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-6 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            <a href="{{ route('admin.ivr-voicemail.create') }}" class="btn btn-outline btn-success btn-sm">Add IVR
                Greetings
            ...
            <div class="white-box">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover toggle-circle default footable-loaded footable"
                        ...
                        <tbody>
                            @foreach ($voicemails as $key => $item)
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td>{{ $item->name }}</td>
                                    <td>
                                    ...
                                    <td class=" text-center">
                                        <div class="btn-group dropdown m-r-10">
                                            ...
                                            <ul role="menu" class="dropdown-menu pull-right">
                                                <li><a href="{{ route('admin.ivr-voicemail.edit', $item->id) }}"
                                                        type="button"><i class="fa fa-pencil" aria-hidden="true"></i>
                                                        Edit</a></li>
                                                <li><a href="{{ route('admin.ivr-voicemails.destroy', $item->id) }}"><i
