    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-inverse">
                <div class="panel-heading">@lang('app.add') IVR Voicemail</div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                {!! Form::open(['id' => 'createIvrVoicemail', 'class' => 'ajax-form', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="audio_clip" id="audio_clip" class="form-control"
                                                autocomplete="nope">
                                        </div>
                                    </div>
                                    <div class="col-md-6" >
...
<script>
    ...
    <script>
        $('#createIvrVoicemail').submit(function(e) {
            e.preventDefault();
            $.easyAjax({
                url: '{{ route('admin.ivr-voicemail.store') }}',
                container: '#createIvrVoicemail',
                type: "POST",
                file: true,
                redirect: true,
                dataType: 'JSON',
