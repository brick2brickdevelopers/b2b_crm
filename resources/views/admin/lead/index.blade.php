                    ...
                    <form action="" id="filter-form">
                        ...
                        <div class="col-xs-12">
                            <div class="form-group">
                                ...
                                <select class="selectpicker form-control" data-placeholder="@lang('modules.tickets.chooseAgents')"
                        ...
                        <div class="col-xs-12">
                            <div class="form-group">
                                ...
                                <select class="select2 form-control" data-placeholder="@lang('modules.lead.leadCategory')"
                                    id="category_id">
    ...
    $("#action_btn").click(function() {
        ...
        if (ids.length !== 0) {
            if ($('#check_action').val() == 'Assign Selected To Campaign') {
                ...
                if (cid) {
                    $.easyAjax({
                        url: "{{ route('admin.leads.assign_lead_campaign') }}",
                        type: "POST",
                        redirect: true,
                        data: {
