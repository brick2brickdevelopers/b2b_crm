                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        ...
                        <div class="form-body">
                            ...
                            <h3 class="box-title required">Lead Detials</h3>
                            <hr>
                            {{-- <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-3 ">
                                    <label>@lang('app.mobile') <span style="color: red">
                                            *</span></label>
                                    @php $code = explode(" ",$lead->mobile); @endphp
                                    <div class="form-group">
                                        <select class="select2 phone_country_code form-control" name="phone_code" required>
                                            <option value="">--</option>
                                            @foreach ($countries as $item)
                                                <option @if ($item->phonecode == $code[0]) selected @endif
                                        ...
                                        <input type="tel" name="mobile" id="mobile" class="mobile"
                                            autocomplete="nope"
                                            value="@if (isset($code[1])) {{ $code[1] }}@else {{ $lead->mobile }} @endif">
                                    </div>
                                </div>
                                <div class="col-md-3 ">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="office_phone" id="office_phone"
                                            value="{{ $lead->office_phone }}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-3 ">
                                    <div class="form-group">
                                        <label>@lang('modules.stripeCustomerAddress.city')</label>
                                        <input type="text" name="city" id="city" value="{{ $lead->city }}"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-3 ">
                                ...
                                <div class="col-md-3 ">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="postal_code" id="postalCode"
                                            value="{{ $lead->postal_code }}" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        <label for="">@lang('modules.tickets.chooseAgents') <a href="javascript:;" id="addLeadAgent"
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" name="value" value="{{ $lead->value }}"
                                            class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="next_follow_up" id="next_follow_up" class="form-control">
                                            <option @if ($lead->next_follow_up == 'yes') selected @endif value="yes">
                                                @lang('app.yes')</option>
                                            <option @if ($lead->next_follow_up == 'no') selected @endif value="no">
                                                @lang('app.no')</option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="form-control">
                                            @forelse($status as $sts)
                                                <option @if ($lead->status_id == $sts->id) selected @endif
                                                    value="{{ $sts->id }}"> {{ ucfirst($sts->type) }}</option>
                                            @empty
                                            @endforelse
                                        </select>
                                    </div>
