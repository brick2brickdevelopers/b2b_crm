                    ...
                    OneSignal.getUserId()
                        .then(function(userId) {
                            if (!userId) {
                                ...
                                if ((db_onesignal_id == null || db_onesignal_id !== userId) && userId !==
                                    null) { //update onesignal ID if it is new
...
<body class="fix-sidebar @if ($rtl == 1) rtl @endif">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="row">
            ...
            data-section">
                    <button
                        class="btn btn-default btn-xs btn-circle btn-outline m-t-5 filter-section-show hidden-sm hidden-md"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            setTimeout(function() {
                ...
                if (getActiveMenu > 0) {
                    $('#side-menu  li.active li a.active').parent().parent().parent().find('a:first')
                        .addClass('active');
                }
