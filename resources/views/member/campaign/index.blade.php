                            ...
                            <tbody>
                                @foreach ($campaigns as $campaign)
                                    ...
                                    <tr>
                                        ...
                                        @php
                                        $available = ManualLoggedCall::where('campaign_id',$campaign->id)->where('call_status','=',0)->where('created_by','=',$userId)->count();
                                        $completed = ManualLoggedCall::where('campaign_id',$campaign->id)->where('call_status','=',1)->where('created_by','=',$userId)->count();
                                        $follow = ManualLoggedCall::where('campaign_id',$campaign->id)->where('call_status','=',2)->where('created_by','=',$userId)->count();
                                        @endphp
                                        <td>
                                            <ul class="p-l-20">
                                        ...
                                        <td>
                                            <ul class="p-l-20">
                                                ...
                                                @php $calOutcomeCount = ManualLoggedCall::where('campaign_id',$campaign->id)->where('created_by','=',$userId)->where('call_outcome_id','=',$callOutcome->id)->count();@endphp
                                        ...
                                        <td class=" text-center">
                                            <div class="btn-group dropdown m-r-10">
                                                ...
                                                <ul role="menu" class="dropdown-menu pull-right">
                                                    <li><a href="{{ route('member.campaigns.edit', $campaign->id) }}" type="button"><i class="fa fa-pencil" aria-hidden="true"></i>
                                                            Edit</a></li>
                                                    <li><a href="{{ route('member.campaigns.view', $campaign->id) }}"><i class="fa fa-search" aria-hidden="true"></i>
                                                            View</a></li>
                                                    <li><a href=""><i class="fa fa-times" aria-hidden="true"></i>
                                                            Delete</a></li>
                                                </ul>
                                            </div>
                                        </td>
