    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-inverse">
                <div class="panel-heading">Update Campaign</div>
                    ...
                    <div class="panel-body">
                        <form method="POST" action="" class="form-horizontal" id="createCampaign">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-lg-10">
                                    <input type="number" class="form-control" id="call_to_call_gap"
                                        name="call_to_call_gap" value="{{ $campaign->call_to_call_gap }}">
                                </div>
                            </div>
                            <div class="form-group row mb-2">
...
@push('footer-script')
    ...
    <script>
        $('#save-form').click(function(event) {
            ...
            const url = "{{ route('member.campaigns.update', ':xid') }}"
