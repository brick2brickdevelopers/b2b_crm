...
<div class="navbar-default sidebar" role="navigation">
            ...
            <li class="dropdown">
                <select class="selectpicker language-switcher" data-width="fit">
                    ...
                    <option value="{{ $language->language_code }}" @if ($global->locale == $language->language_code)
                        selected @endif
                        data-content='<span class="flag-icon flag-icon-{{ $language->language_code }}"></span> {{
    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        ...
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="{{ route('admin.leads.index') }}" class="waves-effect"><i class="fa fa-doc fa-fw"></i>
            ...
            <li><a href="{{ route('admin.clients.index') }}" class="waves-effect"><i class="icon-people fa-fw"></i>
            ...
            <li><a href="{{ route('admin.employees.index') }}" class="waves-effect
                ...
                <ul class="nav nav-second-level {{ request()->is('admin/leave*') ? 'collapse in' : '' }}">
                    ...
                    <li><a href="{{ route('admin.employees.index') }}">
                        ...
                        @endphp
                        <span class="hide-menu">
                                {{$customModuels[$getEmployeeIndex] === null ? "Employee" :
                                $customModuels[$getEmployeeIndex]}}
                            </span>
                    </a>
                </li>
            ...
            <li><a href="{{ route('admin.finance.index') }}" class="waves-effect"><i class="fa fa-money fa-fw"></i>
                    <span class="hide-menu"> @lang('app.menu.finance') @if ($unreadExpenseCount > 0)
                        <div class="notify notification-color"><span class="heartbit"></span><span class="point"></span>
                        </div>
            ...
            @if (in_array('tickets', $modules))
            <li><a href="{{ route('admin.tickets.index') }}" class="waves-effect"><i class="ti-ticket fa-fw"></i> <span
                        class="hide-menu">
            ...
            <li><a href="{{ route('admin.user-chat.index') }}" class="waves-effect"><i class="icon-envelope fa-fw"></i>
                    <span class="hide-menu">
                        ...
                        <span class="label label-rouded label-custom pull-right">{{ $unreadMessageCount }}</span>
                        @endif
                    </span></a> </li>
            @endif
