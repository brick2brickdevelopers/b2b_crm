...
{{-- Campaign Menu --}}
            <li><a href="{{ route('member.campaigns.index') }}" class="waves-effect"><i class="ti-layout-list-thumb fa-fw"></i> <span class="hide-menu"> Campaigns <span class="fa arrow"></span> </span></a>
                <ul class="nav nav-second-level">
...
{{-- Campaign Menu --}}
            ...
            @endforeach
        {{-- Call Log --}}
            <li><a href="#" class="waves-effect"><i class="ti-layout-list-thumb fa-fw"></i> <span class="hide-menu"> Activity <span class="fa arrow"></span> </span></a>
                <ul class="nav nav-second-level">
