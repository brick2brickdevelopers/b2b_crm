        ...
        <ul class="nav" id="side-menu">
            ...
            <li class="user-pro  hidden-sm hidden-md hidden-lg">
                ...
                <ul class="nav nav-second-level">
                    <li><a href="{{ route('member.profile.index') }}"><i class="ti-user"></i> @lang('app.menu.profileSettings')</a>
                    </li>
            ...
            <li><a href="{{ route('member.dashboard') }}" class="waves-effect"><i class="icon-speedometer fa-fw"></i>
                    <span class="hide-menu">@lang('app.menu.dashboard') </span></a> </li>
            {{-- Campaign Menu --}}

            @if (in_array('campaign', $modules))
                @if (user()->sip_pass)
                    <li><a href="{{ route('member.campaigns.index') }}" class="waves-effect"><i
                                class="ti-layout-list-thumb fa-fw"></i> <span class="hide-menu"> Campaigns <span
                                    class="fa arrow"></span> </span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="{{ route('member.campaigns.create') }}">Create Campaign</a></li>
                            <li><a href="{{ route('member.campaigns.index') }}">Campaign List</a></li>
                        </ul>
                    </li>
                @endif
            ...
            @if (in_array('clients', $modules))
                @if ($user->cans('view_clients'))
                    <li><a href="{{ route('member.clients.index') }}" class="waves-effect"><i
                                class="icon-people fa-fw"></i> <span class="hide-menu">@lang('app.menu.clients') </span></a>
                    </li>
                @endif
            @endif
            ...
            @if (in_array('employees', $modules))
                @if ($user->cans('view_employees'))
                    <li><a href="{{ route('member.employees.index') }}" class="waves-effect"><i
                                class="icon-user fa-fw"></i> <span class="hide-menu">@lang('app.menu.employees') </span></a> </li>
                @endif
            @endif

            @if (in_array('projects', $modules))
                <li><a href="{{ route('member.projects.index') }}" class="waves-effect"><i
            ...
            @if (in_array('contracts', $modules) && $user->cans('view_contract'))
                <li><a href="{{ route('member.contracts.index') }}" class="waves-effect"><i
                            class="icon-layers fa-fw"></i> <span class="hide-menu">@lang('app.menu.contract') </span> </a>
                </li>
            @endif

            @if (in_array('products', $modules) && $user->cans('view_product'))
                <li><a href="{{ route('member.products.index') }}" class="waves-effect"><i
                            class="icon-basket fa-fw"></i> <span class="hide-menu">@lang('app.menu.products') </span></a> </li>
            @endif

            @if (in_array('tasks', $modules))
                <li><a href="{{ route('member.task.index') }}" class="waves-effect"><i
                            class="ti-layout-list-thumb fa-fw"></i> <span class="hide-menu"> @lang('app.menu.tasks') <span
                                class="fa arrow"></span> </span></a>
                    <ul class="nav nav-second-level">
                        ...
                        <li class="hidden-sm hidden-xs"><a
                                href="{{ route('member.taskboard.index') }}">@lang('modules.tasks.taskBoard')</a></li>
            ...
            @if (in_array('leads', $modules))
                <li><a href="{{ route('member.leads.index') }}" class="waves-effect"><i
                            class="icon-doc fa-fw"></i> <span class="hide-menu">@lang('app.menu.lead') </span></a> </li>
            @endif

            @if (in_array('timelogs', $modules))
                <li><a href="{{ route('member.all-time-logs.index') }}" class="waves-effect"><i
                            class="icon-clock fa-fw"></i> <span class="hide-menu">@lang('app.menu.timeLogs') </span></a> </li>
            @endif

            @if (in_array('attendance', $modules))
                @if ($user->cans('view_attendance'))
                    <li><a href="{{ route('member.attendances.summary') }}" class="waves-effect"><i
                                class="icon-clock fa-fw"></i> <span class="hide-menu">@lang('app.menu.attendance') </span></a>
                    </li>
                @else
                    <li><a href="{{ route('member.attendances.index') }}" class="waves-effect"><i
                                class="icon-clock fa-fw"></i> <span class="hide-menu">@lang('app.menu.attendance') </span></a>
                    </li>
                @endif
            @endif
            ...
            @if (in_array('holidays', $modules))
                <li><a href="{{ route('member.holidays.index') }}" class="waves-effect"><i
                            class="icon-calender fa-fw"></i> <span class="hide-menu">@lang('app.menu.holiday') </span></a>
                </li>
            @endif

            @if (in_array('tickets', $modules))
                <li><a href="{{ route('member.tickets.index') }}" class="waves-effect"><i
                            class="ti-ticket fa-fw"></i> <span class="hide-menu">@lang('app.menu.tickets') </span></a> </li>
            @endif

            @if ((in_array('estimates', $modules) && $user->cans('view_estimates')) || (in_array('invoices', $modules) && $user->cans('view_invoices')) || (in_array('payments', $modules) && $user->cans('view_payments')) || in_array('expenses', $modules))
                <li><a href="{{ route('member.finance.index') }}" class="waves-effect"><i
                            class="fa fa-money fa-fw"></i> <span class="hide-menu"> @lang('app.menu.finance') @if ($unreadExpenseCount > 0)
                                <div class="notify notification-color"><span class="heartbit"></span><span
                                        class="point"></span></div>
                            @endif <span class="fa arrow"></span> </span></a>
                    <ul class="nav nav-second-level">
                        ...
                        @if (in_array('invoices', $modules))
                            @if ($user->cans('view_invoices'))
                                ...
                                <li><a href="{{ route('member.invoice-recurring.index') }}">@lang('app.invoiceRecurring') </a>
                                </li>
                            @endif
                        @endif
                        ...
                        @if (in_array('expenses', $modules))
                            <li><a href="{{ route('member.expenses.index') }}">@lang('app.menu.expenses') @if ($unreadExpenseCount > 0)
                                        <div class="notify notification-color"><span class="heartbit"></span><span
                                                class="point"></span></div>
                                    @endif
                                </a> </li>
                            <li> <a href="{{ route('member.expenses-recurring.index') }}">@lang('app.menu.expensesRecurring')</a>
                            </li>
                        @endif
                        @if (in_array('invoices', $modules))
                            @if ($user->cans('view_invoices'))
                                <li><a href="{{ route('member.all-credit-notes.index') }}">@lang('app.menu.credit-note') </a>
                                </li>
                            @endif
                        @endif
                    </ul>
            ...
            @if (in_array('messages', $modules))
                <li><a href="{{ route('member.user-chat.index') }}" class="waves-effect"><i
            ...
            @if (in_array('events', $modules))
                <li><a href="{{ route('member.events.index') }}" class="waves-effect"><i
                            class="icon-calender fa-fw"></i> <span class="hide-menu">@lang('app.menu.Events')</span></a>
                </li>
            @endif

            @if (in_array('leaves', $modules))
                <li><a href="{{ route('member.leaves.index') }}" class="waves-effect"><i
                            class="icon-logout fa-fw"></i> <span class="hide-menu">@lang('app.menu.leaves')</span></a> </li>
            @endif

            @if (in_array('notices', $modules))
                <li><a href="{{ route('member.notices.index') }}" class="waves-effect"><i
                            class="ti-layout-media-overlay fa-fw"></i> <span class="hide-menu">@lang('app.menu.noticeBoard')
                        </span></a> </li>
            @endif
            @if (!is_null($faqs))
                <li><a href="{{ route('member.faqs.index') }}" class="waves-effect"><i
                            class="icon-docs fa-fw"></i> <span class="hide-menu">@lang('app.menu.employeeFaq')</span></a> </li>
            @endif
            ...
            @if (in_array('calling', $modules))
                @if (user()->sip_pass)
                    <li><a href="#" class="waves-effect"><i class="ti-layout-list-thumb fa-fw"></i> <span
                                class="hide-menu"> Activity <span class="fa arrow"></span> </span></a>
                        <ul class="nav nav-second-level">
            ...
            <div class="col-lg-6 m-b-5">
                <div class="btn-group dropup user-dropdown">
                    ...
                    <ul role="menu" class="dropdown-menu">
                        ...
                        @endif
                        <li><a href="{{ route('member.profile.index') }}"><i class="ti-user"></i>
