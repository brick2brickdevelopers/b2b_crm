...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(
        ...
        function () {
            Route::group(['middleware' => ['account-setup', 'license-expire']], function () {
                ...
                //Campaign Route
                Route::any('/campaigns/call-purpose', 'CampaignController@callPurpose')->name('campaigns.call-purpose');
                ...
                Route::group(
                    ...
                    function () {
                        ...
                        //Change the module name routes
                        Route::get('/module-setting/change-module-name', ['uses' => 'ChangeModuleNameController@getAllModule'])->name('module-change-name');

                        Route::post('/module-setting/change-module-name/{id}', ['uses' => 'ChangeModuleNameController@updateModule'])->name('store.module-change-name');
    ...
    Route::group(
        ...
        function () {
            ...
            Route::get('leads/callingLeadDetails', ['uses' => 'MemberLeadController@callingLeadDetails'])->name('leads.callingLeadDetails');
            Route::any('leads/load_api', ['uses' => 'MemberLeadController@load_api'])->name('leads.load_api');
            Route::any('leads/storeLead', ['uses' => 'MemberLeadController@storeLead'])->name('leads.storeLead');
